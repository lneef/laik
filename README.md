...
* see experiments.sh for sample executions using the shared memory backend
* when the program is terminated with Strg + C, this might lead to a Segmentation Fault or the shared memory segments are not released
=======
...
>>>>>>> 9bff3a90d4eed2f6f9a8ec0b98f7fc1e4432c734
